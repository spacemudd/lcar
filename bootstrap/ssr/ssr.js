  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>See our Luxury Cars. Audi, BMW, Lamborghini &amp; Roll Royce to name just a few | Luxuria Auto</title><meta name="description" content="See Luxuria Auto’s collection of luxury and prestige cars. All cars are detailed to the highest standard and we offer industry beating warranties and help with insurance. "${_scopeId}>`);
          } else {
            return [
              createVNode("title", null, "See our Luxury Cars. Audi, BMW, Lamborghini & Roll Royce to name just a few | Luxuria Auto"),
              createVNode("meta", {
                name: "description",
                content: "See Luxuria Auto’s collection of luxury and prestige cars. All cars are detailed to the highest standard and we offer industry beating warranties and help with insurance. "
              })
            ];
          }
        }),
